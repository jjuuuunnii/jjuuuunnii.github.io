    ...
    items: [
      {
        ...
        learned: "개발이 검증을 앞지르면 실패 인지가 늦어짐 — 다음 창업은 출시 전 합격선·계측부터",
      },
      {
        index: "02",
        name: "OFF STAGE",
        ...
        status: "2026.08.08 런칭 · 가입 220명 · 종료",
        ...
        learned: "핵심 흐름은 합격선 통과, 재방문이 끊긴 지점은 D7 1.7% — 재사용 주기가 제품 밖(단체사진 촬영)에 있다고 판단해 종료",
      },
    ],
  },
