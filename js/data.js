...
// 수치·사실은 00_프로필/강승준_총정리.md 검증 기록과 덱_수정_태스크/00_README_공통가이드.md 7절 기준표에 맞춰 둘 것 (2026.09.18 갱신)
...
const PORTFOLIO_DATA = {
  ...
  ventures: {
    intro: {
      ...
      lesson:
        "발켄에서는 기술을 고르는 이유는 끝까지 물었지만, 이 사업이 정말 풀어야 할 문제인지는 묻지 않았습니다. 두 번의 공동창업에서는 PM으로 그 질문을 직접 맡았습니다. 포게티는 만든 뒤에 검증 · OFF STAGE는 출시 전 합격선과 계측부터 설정.",
      delta: {
        from: { value: "약 3개월", label: "포게티 · 착수부터 실패를 알아차리기까지 (개발 포함)" },
        to: { value: "19일", label: "OFF STAGE · 런칭부터 종료 판단까지" },
      },
      takeaway:
        "기간 기준: 착수부터 / 런칭부터 · 차이: 출시 전 합격선·계측 → 운영 데이터로 판단",
    },
    program: {
      name: "아산나눔재단 아산 두어스",
